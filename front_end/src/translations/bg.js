const translations = {
  ...
  "admin.allTimeRevenue": "Общи приходи за всички времена",
  "admin.totalOrders": "Общо поръчки",
  "admin.ordersProcessed": "Обработени поръчки",
  ...
  // Add admin section translations in Bulgarian
  "admin.dashboard": "Административен панел",
  "admin.popularProducts": "Най-популярни продукти",
  "admin.searchProducts": "Търсене на продукти или ресторанти...",
  "admin.noPopularProducts": "Няма намерени популярни продукти",
  "admin.recentOrders": "Последни поръчки",
  "admin.timeStats": "Резултати във времето",
  "admin.today": "Днес",
  "admin.week": "Седмица",
  "admin.month": "Месец",
  "admin.orderStatus": "Разпределение на статуса на поръчките",
  "admin.restaurantPerformance": "Представяне на ресторантите",
  "admin.accountsManagement": "Потребителски акаунти",
  "admin.overview": "Общ преглед",
  "admin.statsTitle": "Бизнес статистика",
  "admin.totalRevenue": "Общи приходи",
  "admin.totalOrders": "Общо поръчки",
  "admin.deleteRestaurantWarning": "Сигурни ли сте, че искате да изтриете този ресторант? Това действие не може да бъде отменено.",
  "admin.confirmDeleteRestaurant": "Изтриване на ресторант",
  "admin.restaurantManagement": "Управление на ресторанти",
  "admin.newRestaurant": "Нов ресторант",
  "admin.editRestaurant": "Редактиране на ресторант",
  "admin.restaurantNameLabel": "Име на ресторанта",
  "admin.restaurantAddressLabel": "Адрес на ресторанта",
  "admin.restaurantNamePlaceholder": "Въведете име на ресторанта",
  "admin.restaurantAddressPlaceholder": "Въведете адрес на ресторанта",
  "admin.searchAccounts": "Търсене на акаунти...",
  "admin.searchRestaurants": "Търсене на ресторанти...",
  "admin.searchOrders": "Търсене на поръчки...",
  "admin.noAccounts": "Няма намерени акаунти",
  "admin.noRestaurants": "Няма намерени ресторанти",
  "admin.noOrders": "Няма намерени поръчки",
  
  // Add restaurant section in Bulgarian
  "restaurants.restaurant": "Ресторант",
  "restaurants.name": "Име",
  "restaurants.address": "Адрес",
  "restaurants.title": "Ресторанти",
  "restaurants.addRestaurant": "Добави ресторант",
  
  // Add product section in Bulgarian
