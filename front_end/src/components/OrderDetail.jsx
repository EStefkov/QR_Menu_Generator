...
function OrderDetail() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-12 pb-20 print:bg-white print:pt-4 print:pb-0">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg print:shadow-none">
          ...
          <div className="border-b border-gray-200 dark:border-gray-700 px-4 py-5 sm:p-6">
            <h4 className="text-base font-medium text-gray-900 dark:text-white mb-4">Customer Information</h4>
            <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
              <div className="sm:col-span-1">
                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Name</dt>
                <dd className="mt-1 text-sm text-gray-900 dark:text-white">{order.customerInfo?.name || '—'}</dd>
              </div>
              <div className="sm:col-span-1">
                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Email</dt>
                <dd className="mt-1 text-sm text-gray-900 dark:text-white">{order.customerInfo?.email || '—'}</dd>
              </div>
              <div className="sm:col-span-1">
                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Phone</dt>
                <dd className="mt-1 text-sm text-gray-900 dark:text-white">{order.customerInfo?.phone || '—'}</dd>
              </div>
              <div className="sm:col-span-1">
                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Table Number</dt>
                <dd className="mt-1 text-sm text-gray-900 dark:text-white">{order.customerInfo?.tableNumber || '—'}</dd>
              </div>
              
              {order.customerInfo?.specialRequests && (
                <div className="sm:col-span-2">
                  <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Special Requests</dt>
                  <dd className="mt-1 text-sm text-gray-900 dark:text-white py-2 px-3 bg-gray-50 dark:bg-gray-700 rounded">
                    {order.customerInfo.specialRequests}
                  </dd>
                </div>
              )}
                  ...
                  <li key={index} className="py-4 flex">
                    <div className="flex-1 flex flex-col">
                      <div className="flex justify-between text-sm font-medium">
                        ...
                        <p className="ml-4 text-gray-900 dark:text-white">${(item.price * item.quantity).toFixed(2)}</p>
                      </div>
          ...
          <div className="px-4 py-5 sm:p-6 print:hidden">
            <h4 className="text-base font-medium text-gray-900 dark:text-white mb-4">Update Order Status</h4>
              ...
              <button
                ...
                className={`inline-flex items-center px-4 py-2 border rounded-md shadow-sm text-sm font-medium 
                  ${order.status === 'PENDING' ? 
                    'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-100 border-yellow-300 dark:border-yellow-700 cursor-not-allowed' : 
              ...
              <button
                ...
                className={`inline-flex items-center px-4 py-2 border rounded-md shadow-sm text-sm font-medium 
                  ${order.status === 'COMPLETED' ? 
                    'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-100 border-green-300 dark:border-green-700 cursor-not-allowed' : 
                    'border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700'
                  }
              ...
              <button
                ...
                className={`inline-flex items-center px-4 py-2 border rounded-md shadow-sm text-sm font-medium 
                  ${order.status === 'CANCELLED' ? 
                    'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-100 border-red-300 dark:border-red-700 cursor-not-allowed' : 
                    'border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700'
                  }
                  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 dark:focus:ring-offset-gray-900`}
              >
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 px-4 py-5 sm:p-6">
            <h4 className="text-base font-medium text-gray-900 dark:text-white mb-4">Order QR Code</h4>
            <div className="flex justify-center">
              <div className="p-4 bg-white border border-gray-200 dark:border-gray-700 rounded-lg">
                {qrCode ? (
                  ...
                  <div className="w-48 h-48 flex items-center justify-center bg-gray-100 dark:bg-gray-800">
                    <p className="text-sm text-gray-500 dark:text-gray-400">Loading QR code...</p>
                  </div>
                )}
              </div>
            </div>
