    ...
    <div className="min-h-screen bg-gray-900 pt-12 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="px-4 py-5 sm:p-6">
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
              <div className="sm:col-span-2">
                <label htmlFor="filter" className="block text-sm font-medium text-gray-300">
                  Filter by Status
                </label>
                <select
                  id="filter"
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  className="mt-1 block w-full border-gray-600 bg-gray-700 text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                />
              </div>
                  ...
                  <div className="mt-1 flex rounded-md shadow-sm">
                    <div className="relative flex items-stretch flex-grow focus-within:z-10">
                      ...
                      <input
                        ...
                        className="focus:ring-blue-500 focus:border-blue-500 block w-full rounded-none rounded-l-md pl-10 sm:text-sm border-gray-600 bg-gray-700 text-white"
                        placeholder="Search orders by ID or customer name"
                      />
                    </div>
                    <button
                      type="submit"
                      className="-ml-px relative inline-flex items-center space-x-2 px-4 py-2 border border-gray-600 text-sm font-medium rounded-r-md text-gray-200 bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                    >
                      Search
                    </button>
                  </div>
        ...
        {filteredOrders.length === 0 ? (
          <div className="text-center py-12 bg-gray-800 shadow overflow-hidden sm:rounded-lg">
            <svg
